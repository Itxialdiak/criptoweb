...
-- Started on 2025-01-26 17:28:54
...
6	Hash MD5	Proporcionado el siguiente hash MD5 de un mensaje (pequeño). Averigüa cuál era el texto original.	3	hello	5d41402abc4b2a76b9719d911017c592	El texto original es una palabra en minúsculas de 5 letras.\r\nSi la consola no funciona, tal vez debas buscar alguna forma de desencriptar MD5 en internet. Si buscas "MD5 decrypt" seguramente encuentras varias opciones online.	100	0	t	2
...
3	pbkdf2_sha256$870000$DwWcAimJhsSchfCzDIYGrk$IuZWGTHiBb9QZrIFW6NBU3N9dG3UjBRtDylCZL0QKPs=	2025-01-24 19:13:41.644047+01	f	usertest02	Koldo	Gallostra de Prada	koldogdp@gmail.com	f	t	2025-01-24 19:13:40.624846+01
1	pbkdf2_sha256$870000$asxLJ2kQT1Jeb8UIRYrWcx$0bk0X0iYOcrUtDJcXSXhJ9500mw8owHCpnzFO59jsOA=	2025-01-24 19:54:21.530519+01	t	itxialdiak	Koldo	Gallostra de Prada	koldogdp@gmail.com	t	t	2025-01-05 13:00:17+01
\.
...
72	2025-01-26 17:09:41.159853+01	6	Hash MD5	2	[{"changed": {"fields": ["Pista"]}}]	9	1
73	2025-01-26 17:16:31.73515+01	3	Cifrado Atbash	1	[{"added": {}}]	12	1
74	2025-01-26 17:21:21.436382+01	4	Cifrado de Transposición básico	1	[{"added": {}}]	12	1
75	2025-01-26 17:25:12.327103+01	5	MD5 (Message-Digest Algorithm 5)	1	[{"added": {}}]	12	1
\.
...
9feb723t0xmq1e6wrxnpahyc38w0ck5c	.eJxVjEEOwiAQRe_C2hCG0gIu3XsGMswMUjVtUtqV8e7apAvd_vfef6mE21rT1mRJI6uzAnX63TLSQ6Yd8B2n26xpntZlzHpX9EGbvs4sz8vh_h1UbPVbF7Am-45D3yOJ2ALSGQrgHUHsKFoI1gGbgIXEEUUTIjjv_cDIA4F6fwDbTTee:1tb1NV:LhvlGr-Q0R8BlfhP0TzVsMJHXkHO51MQgSVfBxofFAQ	2025-02-06 18:52:29.886072+01
bb3hxr9shppv65gt1iwkbkbr8xwzlzbe	.eJxVjEEOwiAQRe_C2hCG0gIu3XsGMswMUjVtUtqV8e7apAvd_vfef6mE21rT1mRJI6uzAnX63TLSQ6Yd8B2n26xpntZlzHpX9EGbvs4sz8vh_h1UbPVbF7Am-45D3yOJ2ALSGQrgHUHsKFoI1gGbgIXEEUUTIjjv_cDIA4F6fwDbTTee:1tbOov:m-hR6hAO9LATVqawTFD2PaXSIthLTFrQVb8M9AA_btA	2025-02-07 19:54:21.59834+01
\.
...
SELECT pg_catalog.setval('public.informacion_tecnicacriptografica_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.usuarios_perfil_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.usuarios_usuarioactividad_id_seq', 9, true);
...
-- Completed on 2025-01-26 17:28:54
